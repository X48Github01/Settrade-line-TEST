...
investor = Investor(app_id="MDQfX4OjSGxTPqa", app_secret="BIhomc1bJN4XqCOyIW+OgVK9SqK4WwSJrhKqQjnGORA", broker_id="SANDBOX", app_code = "SANDBOX", is_auto_queue = False)
